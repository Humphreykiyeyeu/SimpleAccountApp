<x-layout>
	<h1 class="text-center pt-5">Withdraw</h1>
	<form method="POST" action="/userwithdraw">
		...
		<div class='container pt-4 col-4'>
			<div class="form-floating mb-3">
				...
				<label for="floatingInput">withdraw from</label>
				@error('name')
			...
			<div class="form-floating mb-3">
				<input type="number" class="form-control" id="floatingInput" placeholder="deposit amount" name="withdrawAmount">
